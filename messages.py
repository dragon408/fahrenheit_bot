# import weather # ONLY FOR TESTS
# import json # ONLY FOR TESTS
...
#     [temp, wind_speed, weather_by_hours] = weather.parse_hourly_weather_forecast(data)

#     # test for get_message_about_temp()
#     [morning_temp, day_temp, evening_temp, night_temp] = temp
#     print(get_message_about_temp(morning_temp, day_temp, evening_temp, night_temp))

#     # test for get_message_about_wind()
#     [morning_wind_speed, day_wind_speed, evening_wind_speed, night_wind_speed] = wind_speed
#     print(get_message_about_wind(morning_wind_speed, day_wind_speed, evening_wind_speed, night_wind_speed))

#     # test for get_message_about_weather()
...
#     print(get_message_about_weather(morning_weather_by_hours, day_weather_by_hours, evening_weather_by_hours, night_weather_by_hours))